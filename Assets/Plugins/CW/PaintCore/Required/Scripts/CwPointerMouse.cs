	...
	public class CwPointerMouse : CwPointer
	{
		...
		protected virtual void Update()
		{
			...
			if (CwInput.GetMouseExists() == true)
			{
				...
				{
					GetFinger(PREVIEW_FINGER_INDEX, PointForColoring.Instance.PointPosition, 1.0f, true, out finger);
				...
				if (enablePaint == true)
				{
					var down = GetFinger(PAINT_FINGER_INDEX, PointForColoring.Instance.PointPosition, 1.0f, true, out finger);
