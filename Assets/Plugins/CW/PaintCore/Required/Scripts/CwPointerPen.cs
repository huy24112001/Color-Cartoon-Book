	...
	public class CwPointerPen : CwPointer
	{
		...
		protected virtual void Update()
		{
			...
			if (GetPenExists() == true)
			{
				...
				{
					GetFinger(PREVIEW_FINGER_INDEX, PointForColoring.Instance.PointPosition, GetPenPressure(), true, out finger);
				...
				if (enablePaint == true)
				{
					var down = GetFinger(PAINT_FINGER_INDEX, PointForColoring.Instance.PointPosition, GetPenPressure(), true, out finger);
